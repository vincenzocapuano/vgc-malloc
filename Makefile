...
LIB    = -pipe -pthread
OPTS   = -DVGC_MALLOC_DEBUG_LEVEL=4 -DVGC_MALLOC_STACKTRACE -DVGC_MALLOC_MPROTECT -UVGC_MALLOC_PKEYMPROTECT -DVGC_MALLOC_STACKTRACE_SIGNAL
...
all:	$(BINDIR)/t1 $(BINDIR)/t2 $(BINDIR)/t3 $(BINDIR)/t4
...
$(LIBDIR)/libvgcmalloc.so:	$(OBJDIR)/vgc_common.o $(OBJDIR)/vgc_pthread.o $(OBJDIR)/vgc_message.o $(OBJDIR)/vgc_malloc.o $(OBJDIR)/vgc_mprotect.o $(OBJDIR)/vgc_pkeymprotect.o $(OBJDIR)/vgc_stacktrace.o $(OBJDIR)/vgc_network.o
